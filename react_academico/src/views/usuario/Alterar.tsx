...
import useUpdateUsuario from '../../service/connection/usuario/UpdateUsuario';
import {
  BUTTON_SIZE,
...
const navegacaoUsuario = {
  titulo: USUARIO_SHOW,
  descricao: `Alterar dados do ${USUARIO_SHOW} no sistema`,
...
const Alterar = () => {
  ...
  const { updateUsuario, errorUpdateUsuario } = useUpdateUsuario();
  const { id } = useParams();
  ...
  const onSubmitData = async (e: MouseEvent<HTMLButtonElement>) => {
    ...
    const data = await updateUsuario(id, model);
                    ...
                    <div className="cadastro mt-3 mb-3">
                      <div className="form-cadastro-usuario">
                        ...
                        <div className="form-cadastro-full">
                          ...
                          <div className="input-button-group-full-width">
                            <input
                              ...
                              onBlur={() => handleBlurField('nomeCidade')}
                              readOnly
                            />
                        ...
                        <Button
                          id="buttonSubmit"
                          type="button"
                          title={`Alterar dados do ${USUARIO_SHOW}`}
                          variant={SUCCESS}
                        ...
                        <LinkButton
                          ...
                          type="button"
                          title={`Cancelar a alteração dos dados do ${USUARIO_SHOW}`}
                          variant={WARNING}
                          cssClass="btn-lg app-button app-label mt-2"
