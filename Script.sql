...
CREATE TABLE CIDADE (
	ID_CIDADE INTEGER  GENERATED ALWAYS AS IDENTITY NOT NULL CONSTRAINT PK_CIDADE PRIMARY KEY,
...
CREATE TABLE USUARIO (
    ID_USUARIO INTEGER GENERATED ALWAYS AS IDENTITY NOT NULL CONSTRAINT PK_USUARIO PRIMARY KEY,
...
CREATE TABLE ALUNO (
    ID_ALUNO INTEGER GENERATED ALWAYS AS IDENTITY NOT NULL CONSTRAINT PK_ALUNO PRIMARY KEY,
...
CREATE TABLE PROFESSOR (
    ID_PROFESSOR INTEGER GENERATED ALWAYS AS IDENTITY NOT NULL CONSTRAINT PK_PROFESSOR PRIMARY KEY,
...
CREATE TABLE ROLE (
    ID NUMBER GENERATED ALWAYS AS IDENTITY NOT NULL CONSTRAINT PK_ROLE PRIMARY KEY,
